...
class paging{
    ...
    public function __construct($lang=null){
        if(is_array($lang))$this->setText($lang);
    ...
    public function get_buttons($url='http://localhost/'){
        $a = $this->start;
        $b = $this->fin;
        $c = $this->current_page;
        $d = $this->total_page;
        ...
        for($i=$a; $i<=$b;$i++){
            $btns[] = array(
                ...
                'link' => reqURL($url,'page',$i),
                'class' => 'btn-'.$i.(($c==$i)?' active active-btn':''),
                'page' => $i
            );
        }
     ...
     * @param Nomber
     */
    public function get_limit_item($type='string',$total=null,$per_page=null,$current_page=null){
